...
public class ModBlocks {
    public static final Block RED_BACKGROUND_BLOCK = registerBlock("red_background_block",
            new Block(FabricBlockSettings.create().strength(-1.0f, 3600000.0f).dropsNothing()),
            ModItemGroups.BGB);
    ...
    public static final Block RED_BACKGROUND_BLOCK_BRIGHTNESS_15 = registerBlock("red_background_block_brightness_15",
            new Block(FabricBlockSettings.create().strength(-1.0f, 3600000.0f).dropsNothing().luminance(state -> 15)),
            ModItemGroups.BGB);
